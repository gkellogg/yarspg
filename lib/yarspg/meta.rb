...
module YARSPG::Meta
  RULES = [
    ...
    EBNF::Rule.new(:primitive_value_schema, "34", [:alt, "Decimal", "SmallInt", "Integer", "BigInt", "Float", "Real", "Double", "Bool", "Null", "String", "Date", "DateTime", "Time"]).extend(EBNF::PEG::Rule),
    ...
    EBNF::Rule.new(:DATETYPE, "52", [:alt, :DATETIME, :DATE, :TIME], kind: :terminal).extend(EBNF::PEG::Rule),
    ...
    EBNF::Rule.new(:DATETIME, "56", [:seq, :DATE, "T", :TIME], kind: :terminal).extend(EBNF::PEG::Rule),
